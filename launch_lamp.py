...
class RtspMediaFactory(GstRtspServer.RTSPMediaFactory):
    ...
    def do_create_element(self, url):
        pipelineCmd = "alsasrc ! queue ! audio/x-raw,format=S16LE,rate=44100,channels=1 ! audiowsinclimit cutoff=9000 ! level name=wavelevel interval=50000000 post-messages=TRUE ! audioconvert ! vorbisenc quality=0.4 ! queue ! rtpvorbispay name=pay0 pt=96"
    ...
    def encoder(self):
        ...
        if clk_state != self.last_clk:
            ...
            if self.state == "streaming":
                ...
                #print("STREAMING: {} | {}".format(self.top_rotation,self.bottom_rotation))
            elif self.state == "broadcasting":
                self.writeBulb(self.top_rotation)
